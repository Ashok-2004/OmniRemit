 ...
 * "OmniRemit", on the same deployment. A bank deploying this will almost certainly want its own
 ...
 *
 * NOTE: the Module Federation bridge names (`OmniRemitHostBridge`, `window.__omniremitHost__`) are
...
export const APP_NAME: string = import.meta.env.VITE_APP_NAME || 'OmniRemit'
